...
public class DisasterNoticeList implements Parcelable {
	...
	public DisasterNoticeList() {
	}

	protected DisasterNoticeList(Parcel in) {
	...
	public static final Parcelable.Creator<DisasterNoticeList> CREATOR = new Parcelable.Creator<DisasterNoticeList>() {
		@Override
		public DisasterNoticeList createFromParcel(Parcel source) {
			return new DisasterNoticeList(source);
		}

		@Override
		public DisasterNoticeList[] newArray(int size) {
			return new DisasterNoticeList[size];
		}
	};
}