...
public class NormalNoticeList implements Parcelable {
	...
	public NormalNoticeList() {
	}

	protected NormalNoticeList(Parcel in) {
	...
	public static final Parcelable.Creator<NormalNoticeList> CREATOR = new Parcelable.Creator<NormalNoticeList>() {
		@Override
		public NormalNoticeList createFromParcel(Parcel source) {
			return new NormalNoticeList(source);
		}

		@Override
		public NormalNoticeList[] newArray(int size) {
			return new NormalNoticeList[size];
		}
	};
}