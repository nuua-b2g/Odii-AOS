...
public class ClearableEditText extends AppCompatEditText implements TextWatcher {
	...
	@DrawableRes
	private static final int DEFAULT_CLEAR_ICON_RES_ID = R.drawable.ic_bt_form_del;
	...
	protected static class ClearIconSavedState extends BaseSavedState {
		...
		public static final Creator<ClearIconSavedState> CREATOR = new Creator<ClearIconSavedState>() {
			@Override
